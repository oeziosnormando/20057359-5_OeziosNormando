<div id="main" class="center">
	<h1  class="text-center" class="display-3">Contato e Localização</h1>
</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="itemContato">
					...
					<h5>Email</h5></a>
					<p class="lead">docecaseiro@doceamor.com.br</p>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-lg-6">
				...
				<form type="post" action="">
					...
					<div class="form-group">
						<label for="FormTextarea">Deixe sua mensagem</label>
